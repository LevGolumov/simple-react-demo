  ...
  en: {
    ...
    about: {
      ...
      text: [
        ...
        "For instance, React Context is used for the locale choice. The Redux saves the table info, fetched from the Firebase by Axios. The pagination is implemented with the React Router.",
        "This was a test assignment from one of the headhunters, and I upgraded it a bit. Initially the React Router, React Context, Redux and Axios weren't there.",
